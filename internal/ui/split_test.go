...
func TestSplitPanelRendering(t *testing.T) {
	...
	out := renderDiffPanel(80, 24, "abcd", 0, false, false, 0, "", false, rows, digits, nil, "", 0, -1, nil, nil, splitView{}, false, nil)
	plain := stripANSI(out)
	...
	sv := splitView{active: true, marked: map[int]bool{}}
	out = renderDiffPanel(80, 24, "abcd", 0, false, false, 0, "", false, rows, digits, nil, "", 0, -1, nil, nil, sv, false, nil)
	if len(out) != 24 {
