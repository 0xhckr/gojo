...
func TestSplitPanelRendering(t *testing.T) {
	...
	out := renderDiffPanel(80, 24, "abcd", 0, false, false, 0, "", false, rows, digits, nil, "", 0, -1, -1, -1, nil, splitView{}, false, nil, nil, -1)
	plain := stripANSI(out)
	...
	sv := splitView{active: true, marked: map[int]bool{}}
	out = renderDiffPanel(80, 24, "abcd", 0, false, false, 0, "", false, rows, digits, nil, "", 0, -1, -1, -1, nil, sv, false, nil, nil, -1)
	if len(out) != 24 {
